  ...
  config = function()
    require('gitsigns').setup {
      on_attach = function(bufnr)
        ...
        map('n', '<leader>hS', gitsigns.stage_buffer, "gitsigns stage whole buffer")
        map('n', '<leader>hR', gitsigns.reset_buffer, "gitsigns reset whole buffer")
        ...
        map('n', '<leader>hQ', function() gitsigns.setqflist('all') end, "gitsigns set all q f list")
        map('n', '<leader>hq', gitsigns.setqflist, "gitsigns set q f list")

        -- Toggles
        map('n', '<leader>tb', gitsigns.toggle_current_line_blame, "git signs toogle current line blame")
        map('n', '<leader>tw', gitsigns.toggle_word_diff, "gitsigns toogle word diff")
